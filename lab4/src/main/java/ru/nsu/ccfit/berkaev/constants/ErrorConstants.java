...
public class ErrorConstants {
    ...
    public static final String USER_NO_ID_ALREADY_MESSAGE = "User with this id doesn't exist";
    public static final String CANT_CONNECT_NEW_CLIENT_MESSAGE = "Cannot connect to new client : ";
    public static final String UNSUPPORTED_OPERATION_CONVERSION_EXCEPTION_MESSAGE = "Unsupported conversion";
