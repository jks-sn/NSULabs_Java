package ru.nsu.ccfit.berkaev.server.participants;
...
public class ParticipantsList {
    ...
    public void addNewParcipiant(String participant, Integer participantID) throws DuplicateNameException {
        ...
        else throw new DuplicateNameException(ErrorConstants.USER_ALREADY_CONNECTED_MESSAGE);
    }
    ...
    public void removeParticipant(Integer participantID) throws DuplicateNameException {
        ...
        else throw new DuplicateNameException(ErrorConstants.USER_NO_NAME_ALREADY_MESSAGE);
    }
    ...
    public String getNameByID(Integer id) throws DuplicateNameException {
        if (! idIsRelevant(id)) throw new DuplicateNameException(ErrorConstants.USER_NO_ID_ALREADY_MESSAGE);
